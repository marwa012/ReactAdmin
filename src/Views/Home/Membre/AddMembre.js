...
const onSubmitHandler=(e)=>{
    ...
    formdata.append('firstname',data.firstname)
     ...
     formdata.append('equipe',data.equipe)
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location='/getmembres'
            UserService.createm(formdata).then(res=>{
                    ...
                    <div className="col-md-12">
                        ...
                        <div className="panel panel-default">
                            ...
                            <div className="panel-body">                                                                        
                                ...
                                <div className="form-group">
                                    <label className="col-md-3 col-xs-12 control-label">Equipes</label>
                                    <div className="col-md-6 col-xs-12">                                            
                                        <div className="col-1">
                                        <select  className="form-control" name="equipe"  onChange={onChangeHandler}>
