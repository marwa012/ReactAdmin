...
const onSubmitHandler=(e)=>{
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
        ...
        DocumentService.updatedoc(id,formdata).then(res=>{
                    ...
                    <div className="col-md-12">
                        ...
                        <div className="panel panel-default">
                            <div className="panel-heading">
                                <h3 className="panel-title"><strong>Update</strong>document </h3>
                            ...
                            <div className="panel-body">                                                                        
                                ...
                                <div className="form-group">
                                    ...
                                    <div className="col-md-6 col-xs-12">                                            
                                        <div className="input-group">
                                            <span className="input-group-addon"><span className="fa fa-pencil"></span></span>
                                            <input type="text" className="form-control" value={data.type} name="type" onChange={onChangeHandler}/>
                                        </div>                                            
