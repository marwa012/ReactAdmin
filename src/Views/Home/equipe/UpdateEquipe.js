  ...
  const onSubmitHandler=(e)=>{
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            navigate('/getequipe')
            EquipeService.update(id,data).then(res=>{
                    ...
                    <div className="col-md-12">
                        ...
                        <div className="panel panel-default">
                            <div className="panel-heading">
                                <h3 className="panel-title"><strong>UPDATE</strong> EQUIPE</h3>
                                ...
                                <div className="form-group">
                                    ...
                                    <div className="col-md-6 col-xs-12">                                            
                                        <div className="input-group">
                                            ...
                                            <input type="text" className="form-control" name="nom" value={data.nom}  onChange={onChangeHandler}/>
                                        </div>                                            
                                      
                                    </div>
                                </div>
                                <div className="form-group">
                                    <label className="col-md-3 col-xs-12 control-label">desc</label>
                                    <div className="col-md-6 col-xs-12">                                            
                                        <div className="input-group">
                                            <span className="input-group-addon"><span className="fa fa-pencil"></span></span>
