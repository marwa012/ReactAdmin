...
const onSubmitHandler=(e)=>{
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            navigate('/getconge')
            CongeService.update(id,data).then(res=>{
                                ...
                                <div className="form-group">
                                    ...
                                    <div className="col-md-6 col-xs-12">                                            
                                        <div className="input-group">
                                            ...
                                            <input type="text" className="form-control" name="raison" value={data.raison}  onChange={onChangeHandler}/>
                                        </div>                                            
